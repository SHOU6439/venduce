...
export default function LikeAnimation({
  ...
  return (
    ...
    >
      <div
        className={`relative transition-transform duration-200 ease-out active:scale-75 ${isAnimating ? "scale-125" : "scale-100"}`}
      >
        <svg
          ...
          className={`${sizeClass} transition-colors duration-300 ${isLiked ? "fill-red-500 text-red-500" : "text-gray-400 group-hover:text-gray-500 fill-transparent"}`}
        >
