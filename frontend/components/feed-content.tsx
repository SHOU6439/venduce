          ...
          {MOCK_POSTS.map((post) => (
            <Card key={post.id} className="overflow-hidden">
              ...
              <div className="relative">
                <img src={post.image || '/placeholder.svg'} alt="投稿画像" className="w-full aspect-square object-cover" />
                {post.products.map((product) => (
                  <Link key={product.id} href={`/product/${product.id}`} className="absolute group" style={{ left: `${product.x}%`, top: `${product.y}%` }}>
